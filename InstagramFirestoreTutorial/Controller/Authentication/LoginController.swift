...
class LoginController: UIViewController {
    ...
    private let forgotPasswordButton: UIButton = {
        let button = UIButton(type: .system)
        button.attributedTitle(firstPart: "Forgot your password", secontPart: "Get help signing in.")
        return button
    }()
    ...
    func configureUI() {
        ...
        stack.anchor(top: iconImage.bottomAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingTop: 32,
